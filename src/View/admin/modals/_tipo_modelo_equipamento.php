<div class="modal fade" id="modal_modelo">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button class="btn btn-primary" name="btn_alterar" id="btn_alterar" onclick="return AlterarModeloEquipamento('form_alt')">Alterar</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
